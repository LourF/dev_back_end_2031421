...
const swaggerDocument = require('./swgger_output.json');
...
app.post('/persons', function(req,res){
    ...
    connection.query("INSERT persons set ?", [details], function (error, rows, fields){
...
app.delete('/persons', function(req,res){
    var id = req.body.id;
    connection.query(" DELETE FROM ficha7.persons WHERE id = ?", [id] , function(error, results , fields){
     res.send("apagados: "+ results.affectedRows);
    });
 });
